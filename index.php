...
<body>
                ...
                <nav class="navbar navbar-expand-lg navic navbar-dark py-3 py-lg-0 px-0">
                    ...
                    <div class="collapse navbar-collapse justify-content-between" id="navbarCollapse">
                        <div class="navbar-nav mr-auto py-0 ">
                           ...
                           <div style="margin-left: 190px; margin-top: 14px;">
                                 <a href="components/wishlist_cart" class="btn px-0">
                                <i class="fas fa-heart text-primary"></i>
                                <span class="badge text-secondary border border-secondary rounded-circle" style="padding-bottom: 2px;">0</span>
                            </a>
                            <a href="components/cart.php" class="btn px-0 ml-3">
        ...
        <div class="row px-xl-5" >
            <div class="col-lg-17">
                <div  id="header-carousel" class="carousel slide carousel-fade mb-30 mb-lg-0" data-ride="carousel">
                    ...
                    <div class="carousel-inner "style="width:1350px;margin-top: 50px;">
                        <div class="carousel-item position-relative active " style="height:600px;">
                            ...
                            <div class="carousel-caption d-flex flex-column align-items-center justify-content-center">
                                <div class="p-3" >
                                    ...
                                    <p class="mx-md-5 px-5 animate__animated animate__bounceIn">Coconut Products</p>
                        ...
                        <div class="carousel-item position-relative" style="height:600px;">
                            ...
                            <div class="carousel-caption d-flex flex-column align-items-center justify-content-center">
                                <div class="p-3" >
                                    ...
                                    <p class="mx-md-5 px-5 animate__animated animate__bounceIn">Tea Products</p>
                                    <a class="btn btn-outline-light py-2 px-4 mt-3 animate__animated animate__fadeInUp" href="shop.php">Shop Now</a>
                                </div>
                            </div>
                        </div>
                        <div class="carousel-item position-relative" style="height: 600px;">
                            ...
                            <div class="carousel-caption d-flex flex-column align-items-center justify-content-center">
                                <div class="p-3" >
                                    <h1 class="display-4 text-white mb-3 animate__animated animate__fadeInDown">GROW RUBBER</h1>
                                    <p class="mx-md-5 px-5 animate__animated animate__bounceIn">Rubber Products</p>
    ...
    <div class="container-fluid pt-5">
        ...
        <div class="row px-xl-5 pb-3">
            ...
            <div class="col-lg-3 col-md-4 col-sm-6 pb-1">
                <a class="text-decoration-none" href="categories/Tea_food_products.php">
                    <div class="cat-item img-zoom d-flex align-items-center mb-4">
                        <div class="overflow-hidden" style="width: 100px; height: 100px;">
                            <img style="margin-top:9px" class="img-fluid" src="img/4.png"alt="">
                        </div>
                        <div class="flex-fill pl-3">
                            <h6>Tea Food Products</h6>
                            <small class="text-body">5 Products</small>
                        </div>
                    </div>
                </a>
            ...
            <div class="col-lg-3 col-md-4 col-sm-6 pb-1">
                <a class="text-decoration-none" href="categories/tea_skin_products.php">
                    <div class="cat-item img-zoom d-flex align-items-center mb-4">
                        <div class="overflow-hidden" style="width: 100px; height: 100px;">
                            <img style="margin-top:9px" class="img-fluid" src="img/5.png" alt="">
                        </div>
                        <div class="flex-fill pl-3">
                            <h6>Tea Skin Products</h6>
                            <small class="text-body">5 Products</small>
                        </div>
                    </div>
                </a>
            ...
            <div class="col-lg-3 col-md-4 col-sm-6 pb-1">
                <a class="text-decoration-none" href="categories/Tea_hair_products.php">
                    <div class="cat-item img-zoom d-flex align-items-center mb-4">
                        <div class="overflow-hidden" style="width: 100px; height: 100px;">
                            <img style="margin-top:14px" class="img-fluid" src="img/6.png" alt="">
                        </div>
                        <div class="flex-fill pl-3">
                            <h6>Tea Hair Products</h6>
                            <small class="text-body">5 Products</small>
                        </div>
                    </div>
                </a>
            ...
            <div class="col-lg-3 col-md-4 col-sm-6 pb-1">
                <a class="text-decoration-none" href="categories/Tea_medicine_products.php">
                    <div class="cat-item img-zoom d-flex align-items-center mb-4">
                        <div class="overflow-hidden" style="width: 100px; height: 100px;">
                            <img class="img-fluid" src="img/7.png" alt="">
                        </div>
                        <div class="flex-fill pl-3">
                            <h6>Tea Medicine Products</h6>
                            <small class="text-body">5 Products</small>
                        </div>
                    </div>
                </a>
             ...
             <div class="col-lg-3 col-md-4 col-sm-6 pb-1">
                <a class="text-decoration-none" href="categories/natural_rubber.php">
                    <div class="cat-item img-zoom d-flex align-items-center mb-4">
                        <div class="overflow-hidden" style="width: 100px; height: 100px;">
                            <img class="img-fluid" src="img/8.png" alt="">
                        </div>
                        <div class="flex-fill pl-3">
                            <h6>Natural Rubber</h6>
                            <small class="text-body">5 Products</small>
                        </div>
                    </div>
                </a>
            ...
            <div class="col-lg-3 col-md-4 col-sm-6 pb-1">
                <a class="text-decoration-none" href="categories/rubber_foot_products.php">
                    <div class="cat-item img-zoom d-flex align-items-center mb-4">
                        <div class="overflow-hidden" style="width: 100px; height: 100px;">
                            <img class="img-fluid" src="img/9.jpg" alt="">
                        </div>
                        <div class="flex-fill pl-3">
                            <h6>Rubber Foot Products</h6>
                            <small class="text-body">5 Products</small>
                        </div>
                    </div>
                </a>
            ...
            <div class="col-lg-3 col-md-4 col-sm-6 pb-1">
                <a class="text-decoration-none" href="categories/rubber_gloves_products">
                    <div class="cat-item img-zoom d-flex align-items-center mb-4">
                        <div class="overflow-hidden" style="width: 100px; height: 100px;">
                            <img class="img-fluid" src="img/11.png" alt="">
                        </div>
                        <div class="flex-fill pl-3">
                            <h6>Rubber Gloves Products</h6>
                            <small class="text-body">5 Products</small>
                        </div>
                    </div>
                </a>
            ...
            <div class="col-lg-3 col-md-4 col-sm-6 pb-1">
                <a class="text-decoration-none" href="categories/rubber_homemade_products.php">
                    <div class="cat-item img-zoom d-flex align-items-center mb-4">
                        <div class="overflow-hidden" style="width: 100px; height: 100px;">
                            <img class="img-fluid" src="img/12.png" alt="">
                        </div>
                        <div class="flex-fill pl-3">
                            <h6>Rubber Homemade Products</h6>
                            <small class="text-body">5 Products</small>
                        </div>
                    </div>
                </a>
            ...
            <div class="col-md-6">
                <div class="contactandabout mb-30" style="height: 300px;">
                    ...
                    <div class="ww">
                        ...
                        <h3 class="text-white  mb-3">Tea Rubber & Coconut Cultivation</h3>
            ...
            <div class="col-md-6">
                <div class="contactandabout mb-30" style="height: 300px;">
                    ...
                    <div class="ww">
                        ...
                        <h3 class="text-white mb-30">3TreeCrops Products</h3>
    ...
    <div class="container-fluid navic text-secondary mt-5 pt-5">
        <div class="row px-xl-5 pt-5">
            <div class="col-lg-4 col-md-12 mb-5 pr-3 pr-xl-5">
                ...
                <p class="mb-0"><i class="fa fa-phone-alt text-primary mr-3"></i>+94 723000823</p>
            </div>
