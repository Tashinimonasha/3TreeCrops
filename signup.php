                ...
                else
                {
                    if($row['email'] == $email)
                     ...
                     else
                     {
                       ...
                       echo "<script type='text/javascript'>alert('$succ');location='index.php'</script>";
                       //email
//
 try {
        ...
        $mail->Username   = '3treecrops2@gmail.com.com';                     //SMTP username
        $mail->Password   = 'txjwjrctbiahfldg';                               //SMTP password
        $mail->SMTPSecure = 'tls';            //Enable implicit TLS encryption
        $mail->Port       = 587;                                    //TCP port to connect to; use 587 if you have set `SMTPSecure = PHPMailer::ENCRYPTION_STARTTLS`
    
        //Recipients
        $mail->setFrom('3treecrops2@gmail.com', '3treecrops');
       ...
       // $mail->addAttachment('/tmp/image.jpg', 'new.jpg');    //Optional name
        ...
        $mail->Body    = '<div style="width: 700px ; background-color:lightgreen; font-weight: bold;text-align: center;font-family: Arial;font-size: 30pt;">Welcome to 3TREECROPS</div><p>Hi,<br>'.$uname.',<br>Thank you for joining with us !'.$email.'</p><p>Stay with us for new product and inforamtion.</p>
           <p>please <a href="mailto:3treecrops2@gmail.com"><b><u>contact</u></b></a> us for more Details. </p>
...
<section style="padding-left: 550px;">
            ...
            <div class="form-content">
                ...
                <form action="#" method="POST" autocomplete="off"  onsubmit="return validateForm()">
                    <div class="field input-field" style="margin:0 0 40px 0;">
                        <input type="text" placeholder="Username" class="input" id="uname" name="uname" onkeyup="validateName()" >
                    ...
                    <div class="field input-field" style="margin:0 0 40px 0;">
                        <input type="password" placeholder="Password" class="input" id="pass" name="pass"  onkeyup="validatePassword()">
                        <span id="Password_Error"></span>
                    </div>
                    <div class="field input-field" style="margin:0 0 40px 0;">
                        <input type="password" placeholder="Confirm Password" class="Confirm Password" id="cpass" name="cpass"  onkeyup="validateConfirm_Password()">
                        <i class='bx bx-hide eye-icon'></i>
                        <span id="Confirm_Password_Error"></span>
                    </div>
                    <div class="field input-field" style="margin:0 0 40px 0;">
                        <label style="font-size: 16px; color: black;"> Customer Type</label>
                        <select name="type" id="type" style="width: 200px; height: 40px; padding-left: 55px;"   onkeyup="validate_User_Role()">
    ...
    var Name=document.getElementById('uname').value.replace(/^\s+|\s+$/g, "");
    if(Name.length == 0)
    {
    ...
    var Passwordx = document.getElementById('pass').value.trim();
    ...
    if((!validateName()) || (!validateUserEmail()) || (!validate_User_Role()) ||  (!validatePassword()) || (!validateConfirm_Password()))
    {
    return false;
    }
    }
