...
<body>
        ...
        <div class="row px-xl-5">
            <div class="col-lg-3 d-none d-lg-block">
                <a class="btn d-flex align-items-center justify-content-between bg-primary w-100" data-toggle="collapse" href="#navbar-vertical" style="height: 65px; padding: 0 30px;">
                    <h6 class="text-dark m-0"><i class="fa fa-bars mr-2"></i>Catogories</h6>
                ...
                <nav class="collapse position-absolute navbar navbar-vertical navbar-light align-items-start p-0 bg-light" id="navbar-vertical" style="width: calc(24.8% - 20px); z-index: 999;">
                    <div class="navbar-nav w-100">
                        ...
                        <a href="../categories/natural_rubber.php" class="nav-item nav-link">Natural Rubber</a>
                        <a href="../categories/rubber_foot_products.php" class="nav-item nav-link">Rubber Foot Products</a>
                        <a href="../categories/rubber_gloves_products.php" class="nav-item nav-link">Rubber Gloves Products</a>
                        <a href="../categories/rubber_homemade_products.php" class="nav-item nav-link">Rubber Homemade Products</a>         
                    </div>
                </nav>
            </div>
            <div class="col-lg-9">
                <nav class="navbar navbar-expand-lg navic navbar-dark py-3 py-lg-0 px-0">
                    ...
                    <div class="collapse navbar-collapse justify-content-between" id="navbarCollapse">
                        <div class="navbar-nav mr-auto py-0 ">
                           ...
                           <div style="margin-left: 85px; margin-top: 14px;">
   ...
   <?php
   $select_products = $conn->prepare("SELECT * FROM `listing` WHERE products='r'");
