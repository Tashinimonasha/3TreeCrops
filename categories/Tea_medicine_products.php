...
<body>
            ...
            <div class="col-lg-3 d-none d-lg-block">
                ...
                <nav class="collapse position-absolute navbar navbar-vertical navbar-light align-items-start p-0 bg-light" id="navbar-vertical" style="width: calc(24.8% - 20px); z-index: 999;">
                    <div class="navbar-nav w-100">
                        ...
                        <a href="Tea_food_products.php" class="nav-item nav-link">Tea Food Products</a>
                        <a href="Tea_skin_products.php" class="nav-item nav-link">Tea Skin Products</a>
                        <a href=" Tea_hair_products.php" class="nav-item nav-link">Tea Hair Products</a>
                       <a href=" Tea_medicine_products.php" class="nav-item nav-link">Tea Medicine Products</a>                
                    </div>
                </nav>
            </div>
            <div class="col-lg-9">
   ...
   <h1 class="heading" style=" padding-left:600px;">Tea Medicine Products</h1>

   <div class="box-container">

   <?php
   $select_products = $conn->prepare("SELECT * FROM `listing` WHERE products='t' && categories='m'");
    ...
    <div class="container-fluid navic text-secondary mt-5 pt-5">
        <div class="row px-xl-5 pt-5">
            <div class="col-lg-4 col-md-12 mb-5 pr-3 pr-xl-5">
                ...
                <p class="mb-2"><i class="fa fa-envelope text-primary mr-3"></i>etreecrops@gmail.com</p>
