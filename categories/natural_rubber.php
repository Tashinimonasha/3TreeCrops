...
<body>
            ...
            <div class="col-lg-3 d-none d-lg-block">
                ...
                <nav class="collapse position-absolute navbar navbar-vertical navbar-light align-items-start p-0 bg-light" id="navbar-vertical" style="width: calc(24.8% - 20px); z-index: 999;">
                    <div class="navbar-nav w-100">
                        ...
                        <a href="rubber_foot_products.php" class="nav-item nav-link">Rubber Foot Products</a>
                        <a href="rubber_gloves_products.php" class="nav-item nav-link">Rubber Gloves Products</a>
   ...
   <h1 class="heading" style=" padding-left:600px;">Natural Rubber</h1>

   <div class="box-container">

   <?php
   $select_products = $conn->prepare("SELECT * FROM `listing` WHERE products='r' && categories='n'");
